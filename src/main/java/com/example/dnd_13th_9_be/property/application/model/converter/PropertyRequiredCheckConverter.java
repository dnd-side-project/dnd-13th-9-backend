...
@Component
public class PropertyRequiredCheckConverter
    implements AbstractEntityConverter<PropertyRequiredCheck, PropertyRequiredCheckModel> {
  ...
  public PropertyRequiredCheck toEntity(ChecklistItem checklistItem) {
    return PropertyRequiredCheck.builder().checklistItem(checklistItem).build();
  }
}
